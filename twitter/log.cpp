...
string transferLog(string &s)
{
    ...
    // cout << "Year: " << v[1] << endl;
    // cout << "Month: " << umap[s.substr(index1 + 4, 3)] << endl;
    // cout << "Day: " << v[0] << endl;
    // cout << "Hour: " << v[2] << endl;
    // cout << "Min: " << v[3] << endl;
    // cout << "Sec: " << v[4] << endl;
...
int main(int argc, char **argv)
{
    vector<string> vs = {"10.10.10.10 - - [27/Sep/2016:05:31:23 +0000] \"GET /1.1/friendship/list.json?user_id=123 HTTP/1.1\" 500 563 19 \"Twitter-iPhone/6.63iOS/10.0.2 (Apple;iPhone7,2;;;;;1)\" 177.177.177.177",
        "10.10.10.10 - - [27/Sep/2016:21:31:23 +0800] \"GET /1.1/friendship/list.json?user_id=123 HTTP/1.1\" 500 563 19 \"Twitter-iPhone/6.63iOS/10.0.2 (Apple;iPhone7,2;;;;;1)\" 177.177.177.177",
